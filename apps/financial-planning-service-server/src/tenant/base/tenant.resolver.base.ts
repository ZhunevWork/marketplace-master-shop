...
export class TenantResolverBase {
  ...
  @graphql.ResolveField(() => [PurchasePrice], { name: "purchasePrices" })
  async findPurchasePrices(
    @graphql.Parent() parent: Tenant,
    @graphql.Args() args: PurchasePriceFindManyArgs
  ): Promise<PurchasePrice[]> {
    const results = await this.service.findPurchasePrices(parent.id, args);
  ...
  @graphql.ResolveField(() => [SalePrice], { name: "salePrices" })
  async findSalePrices(
    @graphql.Parent() parent: Tenant,
    @graphql.Args() args: SalePriceFindManyArgs
  ): Promise<SalePrice[]> {
    const results = await this.service.findSalePrices(parent.id, args);
